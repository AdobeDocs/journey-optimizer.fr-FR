...
Les tableaux **[!UICONTROL Optimisation de l’heure d’envoi]** vous donnent des informations sur les performances de vos e-mails ou messages push optimisés et contrôlés. Utilisez-le pour comparer des mesures clés, telles que les envois, les ouvertures, les clics et les bounces, afin de voir l’évolution de chaque variante et d’éclairer vos décisions d’optimisation.

Notez que les mesures de ce rapport, y compris l’**[!UICONTROL Effet élévateur]** et le **[!UICONTROL Degré de confiance]**, sont calculées à partir de **60 jours** d’envois et d’engagement.

+++ En savoir plus sur les mesures d’optimisation de l’heure d’envoi

* **[!UICONTROL Envois]** : nombre total d’envois de chaque variante de message.

* **[!UICONTROL Ouvertures]** : nombre total d’événements ouverts enregistrés pour le message.

* **[!UICONTROL Taux d’ouverture]** : pourcentage de messages envoyés pour lesquels le profil a ouvert le message au moins une fois.

* **[!UICONTROL Effet élévateur]** : pourcentage d’amélioration du taux de conversion pour un traitement donné par rapport à la variante de base. L’effet élévateur quantifie l’ampleur d’une différence ; interprétez-la avec **[!UICONTROL degré de confiance]**.

* **[!UICONTROL Confiance]** : force statistique des preuves selon lesquelles le taux d’ouverture ou de clic de la variante optimisée pour l’heure d’envoi diffère de la variante de contrôle (heure d’envoi attribuée de manière aléatoire). Il est calculé avec un test en Z à deux proportions.
