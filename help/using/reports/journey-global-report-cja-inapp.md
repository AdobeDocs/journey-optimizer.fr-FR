...
description: Découvrez comment utiliser les données in-app du rapport de parcours
...
**Sur cette page :** découvrez comment lire les mesures des messages in-app dans le rapport de parcours, y compris l’affichage et les clics de tendance, les données de tracking et les libellés des liens trackés pour vos messages in-app.
