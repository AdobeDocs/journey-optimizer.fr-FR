...
**Sur cette page :** découvrez comment lire le rapport de campagne web dans Adobe Journey Optimizer pour analyser les tendances des impressions et des clics, les données de tracking et les liens trackés pour vos pages web.
