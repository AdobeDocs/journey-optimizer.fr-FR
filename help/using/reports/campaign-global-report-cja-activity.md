...
**Sur cette page :** Découvrez comment lire le rapport de campagne d’activité dynamique dans Adobe Journey Optimizer pour effectuer le suivi des statistiques d’envoi, des événements du cycle de vie d’une activité dynamique, des raisons d’erreur et des raisons d’exclusion.
