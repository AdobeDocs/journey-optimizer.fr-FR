...
**Sur cette page :** découvrez comment lire le rapport de campagne in-app dans Adobe Journey Optimizer pour analyser les tendances d’affichage et de clic, les données de tracking et les liens trackés pour vos messages in-app.
