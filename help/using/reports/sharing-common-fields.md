...
# Voyage-étapes événements champs communs {#sharing-common-fields}

![](../assets/do-not-localize/badge.png)

Ce mixin sera partagé par les variables voyageStepEvent et voyageStepProfileEvent.

Il s’agit des champs XDM courants que [!DNL Journey Optimizer] envoie à Adobe Experience Platform. Des champs communs seront envoyés pour chaque étape qui est traitée dans un parcours. Des champs plus spécifiques sont utilisés pour les actions et enrichissements personnalisés.
...
Indique si l’utilisateur est revenu sur le parcours avec la même instance. Si elle n’est pas présente, nous supposons que la valeur est false.
...
ID de la version du parcours. Cet id représente la référence d&#39;identité au parcours, dans le cas de l&#39;événement travelStepEvent.
...
Index de la périodicité si le parcours est batch et récurrent (la première exécution a périorenceIndex = 1).
