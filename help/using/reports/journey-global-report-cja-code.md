...
**Sur cette page :** Découvrez comment lire les mesures d’expérience basées sur le code dans le rapport de parcours, y compris les données d’affichage et de clic, les données de suivi et les libellés des liens suivis pour vos expériences basées sur le code.
