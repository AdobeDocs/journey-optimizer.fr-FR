...
**Sur cette page :** découvrez comment lire les mesures de publipostage direct dans le rapport de parcours, y compris les statistiques d’envoi, le statut de la diffusion, les raisons de l’erreur et les raisons d’exclusion de vos messages de publipostage direct.
