...
**Sur cette page :** Découvrez les raisons d’exclusion, les codes d’erreur et les canaux affectés qui empêchent l’envoi de messages, et comment les exclusions sont comptabilisées dans vos rapports de campagne.
