...
| EmailNoAddressDefinedInPreset | 050021 | E-mail | Un événement d’exclusion est généré lorsque l’adresse d’exécution n’est pas définie dans la surface. |
...
| PushNoValidTokenFoundForApps | 050031 | Notification push | Un événement d’exclusion est généré lorsqu’aucun jeton valide n’est trouvé pour les applications ciblées dans la surface. |
...
| SMSFromNumberNotDefinedInPreset | 050152 | SMS | Un événement d’exclusion est généré lorsque FromNumber n’est pas défini dans la surface. |
| SMSNoToNumberDefinedInProfile | 050153 | SMS | Un événement d’exclusion est généré lorsque ToNumber n’est pas défini dans la surface. |
