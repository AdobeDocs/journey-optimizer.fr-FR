...
Vous pouvez accéder à votre rapport de parcours de notification push en cliquant sur le bouton **[!UICONTROL Afficher le rapport]** de votre parcours. [En savoir plus](report-gs-cja.md)
