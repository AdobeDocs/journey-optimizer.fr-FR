...
**Sur cette page :** utilisez le rapport global de campagne Adobe Journey Optimizer pour consulter les statistiques de diffusion, cibler des objectifs spécifiques et comparer les performances des variantes dans le rapport d’expérimentation.
