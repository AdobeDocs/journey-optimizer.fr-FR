...
**Sur cette page :** comprenez comment les politiques de décision utilisent le moteur de prise de décision, ainsi que leurs mécanismes de sécurisation et étapes clés, afin que vous puissiez diffuser les meilleures offres à chaque membre de l’audience.
...
* **Canaux pris en charge** - Expérience basée sur le code, e-mail, SMS, notifications push et publipostage direct.
