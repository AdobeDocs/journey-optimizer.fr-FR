...
**Sur cette page :** créez des collections qui regroupent vos éléments de décision avec des règles basées sur des attributs afin que vous puissiez organiser vos offres et les réutiliser ultérieurement dans vos stratégies de sélection.
