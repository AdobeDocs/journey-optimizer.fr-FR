...
1. Sélectionnez **[!UICONTROL Insérer une politique]** (expérience basée sur un code) ou **[!UICONTROL Insérer une syntaxe]** (e-mail) pour ajouter le code correspondant à la politique de décision.
