...
**Sur cette page :** Découvrez comment le modèle d’apprentissage du renforcement d’optimisation automatique explore et classe les offres pour maximiser le taux de clic publicitaire afin que vous puissiez décider quand l’utiliser pour l’optimisation à canal unique.
