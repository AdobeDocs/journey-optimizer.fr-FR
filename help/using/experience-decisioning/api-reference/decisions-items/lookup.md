...
Vous pouvez rechercher un élément de décision spécifique en adressant une requête GET à l’API de bibliothèque des offres qui inclut l’identifiant dans le chemin de la requête.
