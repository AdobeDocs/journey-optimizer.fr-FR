...
**Sur cette page :** ajoutez et configurez une politique de décision dans le contenu de votre campagne ou de votre parcours afin de renvoyer et de classer les meilleurs éléments de décision pour chaque profil sur les canaux pris en charge.
...
1. [Attribuer un emplacement](#placement) (canal e-mail uniquement)
