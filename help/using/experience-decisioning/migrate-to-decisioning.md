---
title: Migration de la gestion des décisions vers la prise de décision
...
# Migration de la gestion des décisions vers la prise de décision {#migrate-to-decisioning}
...
L’équipe Journey Optimizer travaille actuellement sur des API d’outils de migration pour migrer les entités de gestion des décisions vers la prise de décision. Ces outils permettent une migration transparente entre les sandbox avec des fonctionnalités de résolution de dépendance et de restauration. Si cela vous intéresse, contactez votre représentant ou représentante Adobe.
