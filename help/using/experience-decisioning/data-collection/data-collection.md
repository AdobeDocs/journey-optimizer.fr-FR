...
**Sur cette page :** découvrez comment les commentaires sur la prise de décision concernant les impressions, les clics et les événements personnalisés sont collectés dans Adobe Experience Platform, afin que vous puissiez alimenter les rapports de prise de décision, les règles de limitation et les modèles de classement par l’IA.
