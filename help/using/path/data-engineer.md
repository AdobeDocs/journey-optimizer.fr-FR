...
1. **Création de profils de test**. Les profils de test sont requis lors de l’utilisation du [mode test](../building-journeys/testing-the-journey.md) dans un parcours et pour [prévisualiser et tester vos messages](../preview.md) avant l’envoi. Découvrez comment créer des profils de test dans [cette page](../../using/building-journeys/creating-test-profiles.md). 
