...
**Sur cette page :** créez une carte de contenu et définissez son contenu dans un parcours ou une campagne afin de pouvoir diffuser des expériences in-app personnalisées selon les règles de diffusion de votre choix.
