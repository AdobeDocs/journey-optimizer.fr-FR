...
Une fois que le destinataire s’est désabonné en cliquant sur le lien de désabonnement, une API Adobe I/O est appelée pour mettre à jour la préférence de profil correspondante.
...
[!DNL Journey Optimizer] utilisera ces paramètres pour mettre à jour le choix du profil correspondant.
