...
>[!CAUTION]
>
> Les images provenant d’[Adobe Experience Manager Assets](../content-management/assets.md) ne peuvent pas être référencées lors de l’utilisation de cette méthode. Les images référencées dans votre code HTML doivent être stockées dans un emplacement public.
