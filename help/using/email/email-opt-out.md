...
>title="Ajouter un lien de désabonnement dans l’en-tête de l’e-mail"
>abstract="Activez l’en-tête de désabonnement de liste pour ajouter un lien de désabonnement dans l’en-tête de l’e-mail. Pour définir une URL de désabonnement, insérez un lien d’opt-out en un clic dans le contenu de l’e-mail."
...
Si vous avez activé l’option **[!UICONTROL Activer List-Unsubscribe]** concernant l’en-tête List Unsubscribe, nous vous recommandons d’activer les deux méthodes - **Mailto (désabonner)** et **URL de désabonnement en un clic**. Tous les clients de messagerie ne prennent pas en charge la méthode HTTP. La fonctionnalité de désabonnement à la liste (Mailto list-unsubscribe) vous permet de sélectionner une alternative. Votre réputation d’expéditeur peut être mieux protégée et tous vos destinataires peuvent avoir accès à la fonctionnalité de désabonnement. [En savoir plus](email-settings.md#list-unsubscribe)
