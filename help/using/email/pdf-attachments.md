...
**Sur cette page :** découvrez comment joindre un fichier PDF statique à vos e-mails, y compris la taille du fichier et les limites de volume d’envoi qui s’appliquent.
