...
>abstract="Pour commencer à créer votre contenu d&#39;email, sélectionnez un modèle d&#39;usine ou un modèle existant personnalisé - créé entièrement ou enregistré comme modèle à partir d&#39;un précédent email."
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/email/content-templates.html?lang=fr#create-content-templates" text="Créer des modèles de contenu"
...
* **Modèles enregistrés**. Vous pouvez également utiliser un modèle personnalisé que :
   ...
   * vous avez créé à l’aide du menu **[!UICONTROL Modèles de contenu]** ; [En savoir plus](content-templates.md#create-template-from-scratch).

   * vous avez enregistré dans un email dans un parcours ou une campagne à l’aide de l’option **[!UICONTROL Enregistrer en tant que modèle de contenu]**. [En savoir plus](content-templates.md#save-as-template).
