...
Diffusez des mises à jour persistantes en temps réel directement sur l’écran de verrouillage d’iPhone et Dynamic Island. Mettez en production des activités à partir de campagnes déclenchées par API pour des cas d’utilisation individuels (suivi des commandes, statut de la balade) ou des cas d’utilisation de diffusion (scores sportifs, statut de vol).

[En savoir plus sur les activités iOS Live](../mobile-live/get-started-mobile-live.md)
:::
...
Découvrez comment intégrer et utiliser la messagerie WhatsApp via l’API Cloud Meta pour des campagnes et des parcours de communication personnalisés et conformes.

[En savoir plus sur la messagerie WhatsApp](../../rp_landing_pages/whatsapp-landing-page.md)
:::
...
[En savoir plus sur la messagerie LINE](../../rp_landing_pages/line-landing-page.md)
:::
