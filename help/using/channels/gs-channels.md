...
Diffusez des mises à jour constantes en temps réel directement sur l’écran de verrouillage des iPhone et dans Dynamic Island. Utilisez les activités en direct à partir de campagnes déclenchées par API pour des cas d’utilisation individuels (suivi des commandes, statut des attractions) ou des cas d’utilisation de diffusion (scores sportifs, statut de vol).

[En savoir plus sur les activités en direct iOS](../mobile-live/get-started-mobile-live.md)
:::
...
[En savoir plus sur les messages mobiles](../mobile/get-started-mobile.md)
:::
...
[En savoir plus sur le courrier](../../rp_landing_pages/direct-mail-landing-page.md)
:::
...
Découvrez comment intégrer et utiliser les messages WhatsApp via l’API Cloud de Meta pour des campagnes et parcours de communication personnalisés et conformes.

[En savoir plus sur les messages WhatsApp](../../rp_landing_pages/whatsapp-landing-page.md)
:::
...
Découvrez comment configurer, créer et personnaliser des messages LINE pour une communication efficace dans les campagnes et les parcours.

[En savoir plus sur les messages LINE](../../rp_landing_pages/line-landing-page.md)
:::
