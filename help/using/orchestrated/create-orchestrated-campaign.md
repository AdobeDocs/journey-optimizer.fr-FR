...
**Sur cette page :** découvrez comment créer une campagne orchestrée dans Adobe Journey Optimizer et définir son planning d’exécution pour l’exécuter immédiatement, à une date et une heure spécifiques ou sur une base récurrente.
...
1. Cliquez sur le bouton **[!UICONTROL Créer une campagne]** et sélectionnez le type de campagne **[!UICONTROL Orchestration - Marketing et transactionnel]**.

   Vous choisissez si chaque message est marketing ou transactionnel lorsque vous ajoutez une [activité de canal](../orchestrated/activities/channels.md).
...
![Planificateur configuré pour exécuter la campagne deux fois par jour à 9 h et 12 h](assets/scheduler-sample.png){width="50%"}
