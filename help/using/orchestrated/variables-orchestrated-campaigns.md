...
**Sur cette page :** découvrez comment définir des variables à partir d’un signal ou de définitions globales et les utiliser pour orienter le ciblage, les conditions et la logique d’activité Test dans les campagnes orchestrées.
