...
**Sur cette page :** découvrez comment créer, appliquer, partager et gérer des filtres prédéfinis pour réutiliser les requêtes enregistrées dans le créateur de règles pour les campagnes orchestrées.
