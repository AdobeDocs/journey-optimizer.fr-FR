...
**Sur cette page :** Découvrez comment utiliser l’activité de contrôle de flux d’attente pour introduire un délai temporel entre deux activités d’une campagne orchestrée afin d’obtenir des suivis plus opportuns.
