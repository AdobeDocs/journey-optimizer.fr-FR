...
**Sur cette page :** Découvrez comment utiliser l’activité Contrôle de flux branchement dans une campagne orchestrée pour créer plusieurs transitions sortantes qui exécutent plusieurs activités en parallèle.
