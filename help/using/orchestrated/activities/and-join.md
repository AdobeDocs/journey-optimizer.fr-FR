...
**Sur cette page :** Découvrez comment utiliser l’activité de contrôle de flux Rendez-vous dans une campagne orchestrée pour synchroniser plusieurs branches d’exécution afin que la campagne ne se poursuive qu’une fois toutes les activités précédentes terminées.
