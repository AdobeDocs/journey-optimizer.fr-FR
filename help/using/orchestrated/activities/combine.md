...
**Sur cette page :** découvrez comment utiliser l’activité Combiner le ciblage dans une campagne orchestrée pour segmenter votre population entrante par le biais d’opérations d’union, d’intersection ou d’exclusion.
