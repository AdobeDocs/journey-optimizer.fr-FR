...
Lors de l’envoi de messages à partir de parcours ou de campagnes, vous devez toujours vous assurer que les clients peuvent se désabonner de futures communications. Une fois désinscrits, les profils sont automatiquement supprimés de l’audience des futurs messages marketing.
...
&lt;/a&gt;
&lt;div&gt;&lt;a href=" ../email/email-opt-out.md"><strong>Gérer le processus d’opt-out aux e-mails</strong>
</div>
<p>
</td>
<td>
...
&lt;/a&gt;
&lt;div&gt;
&lt;a href=" ../sms/sms-opt-out.md"><strong>Gestion des processus d’opt-out des SMS</strong></a>
</div>
<p></td>
</tr></table>
