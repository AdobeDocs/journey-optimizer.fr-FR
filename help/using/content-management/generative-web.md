...
description: Commencez à générer le contenu et la ressource de la page web à l’aide de l’assistant d’IA dans Journey Optimizer pour l’accélération de contenu.
...
Une fois que vous avez créé et personnalisé vos pages web, utilisez l’assistant d’IA dans Journey Optimizer pour l’accélération du contenu, optimisé par l’IA générative, pour passer votre contenu au niveau supérieur.
...
1. Sélectionnez un **[!UICONTROL composant de texte]** pour cibler uniquement un contenu spécifique. et accédez au menu **[!UICONTROL Afficher l’assistant d’IA]** .
...
1. Personnalisez votre invite avec l’option **[!UICONTROL Paramètres de texte]** :
   ...
   * **[!UICONTROL Tone]** : le ton de votre page web doit résonner avec votre audience. Que vous souhaitiez communiquer de façon informative, ludique ou convaincante, l’assistant IA peut adapter le message en conséquence.
...
Une fois que vous avez défini les paramètres de votre campagne web et que vous avez modifié votre contenu selon vos besoins à l’aide du concepteur web, vous pouvez passer en revue et activer votre campagne web. [En savoir plus](../web/create-web.md#activate-web-campaign)

>[!TAB Génération d’images de page web]

Dans l’exemple ci-dessous, découvrez comment tirer parti de l’assistant d’IA dans Journey Optimizer pour l’accélération du contenu afin d’optimiser et d’améliorer vos ressources, ce qui vous permet d’offrir une expérience plus conviviale.
...
1. Dans le menu de droite, sélectionnez **[!UICONTROL Afficher l’assistant d’IA]**.
