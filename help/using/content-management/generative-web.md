...
description: Commencez à générer le contenu et la ressource de la page web à l’aide de l’assistant IA dans Journey Optimizer pour l’accélération de contenu.
...
# Génération de pages web avec l’accélérateur de contenu de l’assistant d’IA {#generative-web}
...
Une fois que vous avez créé et personnalisé vos e-mails, utilisez l’assistant IA dans Journey Optimizer pour l’accélération de contenu optimisé par l’IA générative pour améliorer votre contenu.

L’assistant IA dans Journey Optimizer pour l’accélération de contenu peut vous aider à optimiser l’impact de vos diffusions en suggérant un contenu différent et davantage susceptible de résonner auprès de votre audience.
...
Dans l’exemple ci-dessous, découvrez comment tirer parti de l’assistant IA dans Journey Optimizer pour l’accélération de contenu pour optimiser et améliorer vos ressources, afin d’offrir une expérience plus conviviale.
