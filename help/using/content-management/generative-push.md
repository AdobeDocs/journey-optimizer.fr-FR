...
title: Génération de notifications push avec l’assistant IA dans Journey Optimizer pour l’accélération de contenu
description: Commencez à générer du contenu par notifications push avec l’assistant IA dans Journey Optimizer pour l’accélération du contenu.
...
Une fois que vous avez créé et personnalisé vos messages, améliorez la qualité du contenu de votre notification push avec l’assistant IA dans Journey Optimizer pour l’accélération de contenu.
...
Dans cet exemple particulier, apprenez à envoyer une notification push accrocheuse à l’aide de l’assistant IA dans Journey Optimizer pour l’accélération de contenu.
...
1. Activez l’option **[!UICONTROL Utiliser le contenu d’origine]** de l’assistant IA pour l’accélération de contenu afin de personnaliser l’option du nouveau contenu en fonction du contenu sélectionné.
...
Dans cet exemple particulier, apprenez à utiliser l’assistant IA dans Journey Optimizer pour l’accélération de contenu pour du contenu spécifique. Procédez de la façon suivante :
