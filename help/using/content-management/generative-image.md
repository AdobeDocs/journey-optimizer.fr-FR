...
**Sur cette page :** découvrez comment utiliser l’assistant AI dans Adobe Journey Optimizer pour générer, affiner et sélectionner des images sur la marque pour votre contenu d’e-mail, de site web, de page de destination et de notification push.
...
1. Adaptez votre prompt avec l’option **[!UICONTROL Paramètres des images]** :
   ...
   * **[!UICONTROL Modèle génératif]** : faites votre choix parmi le **[!UICONTROL modèle Adobe prêt à l’emploi]** le **[!UICONTROL modèle partenaire]** pour les fonctionnalités spécialisées ou les **[!UICONTROL modèles personnalisés]** formés sur les ressources de votre marque. [En savoir plus](generative-models.md). Pour utiliser le modèle partenaire (**Gemini**) avec des **superpositions de texte** sur des images générées, consultez [Utiliser Gemini comme modèle génératif pour les images superposées de texte](generative-uc.md#generative-gemini).
