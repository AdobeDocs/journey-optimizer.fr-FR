...
**Sur cette page :** Commencez avec du contenu multilingue pour créer des messages dans plusieurs langues au sein d’une seule campagne ou d’un seul parcours, à l’aide d’une traduction manuelle ou automatisée, et passez en revue les conditions préalables requises.
