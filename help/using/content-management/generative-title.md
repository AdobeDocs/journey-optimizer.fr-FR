...
En utilisant l’assistant de contenu, vous avez la possibilité d’optimiser l’impact de votre message en testant différents titres principaux. Chaque variante est considérée comme un traitement unique, afin de mesurer et de comparer le titre qui génère le plus de clics.
...
1. Créez votre message et ajoutez l’expérimentation du contenu. En savoir plus sur l’expérimentation du contenu dans [cette section](../campaigns/content-experiment.md).
...
1. Pour votre second **[!UICONTROL Traitement]**, utilisez l’assistant de génération pour modifier le titre.
