...
1. Vous devez utiliser la commande `sendEvent` et spécifier l’ [URI de surface](code-based-configuration.md#surface-definition)<!--( or location/path)--> pour récupérer le contenu de personnalisation.
