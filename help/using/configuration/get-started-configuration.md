...
**Sur cette page :** découvrez les étapes de configuration de vos canaux, sous-domaines, préchauffage d’adresses IP et règles métier pour commencer à envoyer des messages dans Adobe Journey Optimizer.
