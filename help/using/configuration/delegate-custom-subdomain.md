...
**Sur cette page :** Découvrez comment configurer un sous-domaine personnalisé dans Adobe Journey Optimizer à l’aide de la méthode de délégation personnalisée, qui vous permet de conserver la propriété totale de vos sous-domaines et de vos certificats SSL.
