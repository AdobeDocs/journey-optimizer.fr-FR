...
**Sur cette page :** découvrez DMARC, le fonctionnement de ses politiques et comment configurer et gérer les enregistrements DMARC pour vos sous-domaines délégués directement dans Adobe Journey Optimizer.
