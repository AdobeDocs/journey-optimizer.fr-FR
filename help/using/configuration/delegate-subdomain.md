...
**Sur cette page :** découvrez comment déléguer vos sous-domaines d’envoi d’e-mail à Adobe dans Adobe Journey Optimizer à l’aide de la délégation complète ou de la configuration CNAME, et comment y accéder, les valider et les annuler.
