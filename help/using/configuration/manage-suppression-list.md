...
Pour accéder à la liste détaillée des adresses email exclues, accédez à **[!UICONTROL Administration]** > **[!UICONTROL Canaux]** > **[!UICONTROL Configuration des emails]**, puis sélectionnez **[!UICONTROL Liste de suppression]**.

>[!CAUTION]
>
>Les autorisations d’affichage, d’exportation et de gestion de la liste de suppression sont limitées à [Administrateurs de Parcours](../administration/ootb-product-profiles.md#journey-administrator). Pour en savoir plus sur la gestion des [!DNL Journey Optimizer] droits d’accès des utilisateurs, consultez [cette section](../administration/permissions-overview.md).
...
Si vous ajoutez manuellement une adresse email ou un domaine par erreur, le bouton **[!UICONTROL Supprimer]** permet de supprimer cette entrée.

>[!CAUTION]
>
>N’utilisez jamais le bouton **[!UICONTROL Supprimer]** pour supprimer les adresses électroniques ou domaines supprimés.

![](../assets/suppression-list-delete.png)

La suppression d’une adresse électronique ou d’un domaine de la liste de suppression signifie que vous commencerez à envoyer à nouveau l’adresse à cette adresse ou à ce domaine. Par conséquent, cela peut avoir de graves répercussions sur votre délivrabilité et votre réputation IP, ce qui peut entraîner le blocage de votre adresse IP ou de votre domaine d’envoi. En savoir plus sur l’importance de la maintenance d’une liste de suppression dans [cette section](../suppression-list.md).
...
| **[!UICONTROL Plainte au spam]** | Le message a été bloqué car marqué comme indésirable par le destinataire. | Hard |
...
Cependant, vous pouvez également remplir manuellement la liste de suppression [!DNL Journey Optimizer] pour exclure des adresses électroniques et/ou domaines spécifiques de votre envoi.

Vous pouvez ajouter des adresses électroniques ou des domaines [un à la fois](#add-one-address-or-domain) ou [en mode groupé](#upload-csv-file) par le biais d’un téléchargement de fichier CSV.

Pour cela, cliquez sur le bouton **[!UICONTROL Ajouter un email ou un domaine]**, puis suivez l’une des méthodes ci-dessous.

![](../assets/suppression-list-add-email.png)

### Ajouter une adresse ou un domaine {#add-one-address-or-domain}

1. Sélectionnez l’option **[!UICONTROL Une par une]**.

   ![](../assets/suppression-list-add-email-address.png)

1. Choisissez le type d&#39;adresse : **[!UICONTROL Adresse électronique]** ou **[!UICONTROL Adresse du domaine]**.

1. Saisissez l&#39;adresse email ou le domaine que vous souhaitez exclure de votre envoi.

   >[!NOTE]
   >
   >Veillez à saisir une adresse électronique valide (par exemple abc@company) ou un domaine (par exemple abc.company.com).
...
1. Une fois l’opération terminée, faites glisser et déposez votre fichier CSV, puis cliquez sur **[!UICONTROL Télécharger le fichier]**.
