...
Pour éviter que les e-mails soient marqués comme spam, vous pouvez augmenter progressivement le volume envoyé à l’aide de la fonctionnalité du plan de préchauffage d’adresses IP. Cette nouvelle option du menu **[!UICONTROL Administration]** vous permet d’automatiser la gestion des volumes et de simplifier le processus de préchauffage sans nécessiter de configurations de parcours complexes.
