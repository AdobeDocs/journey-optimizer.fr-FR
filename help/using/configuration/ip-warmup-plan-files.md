...
**Sur cette page :** téléchargez le modèle de plan de préchauffage d’adresses IP vierge et un fichier exemple rempli pour préparer votre plan dans Adobe Journey Optimizer.
