...
**Sur cette page :** découvrez comment les enregistrements PTR sont automatiquement créés lorsque vous déléguez des sous-domaines à Adobe et comment y accéder, les modifier et suivre les mises à jour dans Adobe Journey Optimizer.
