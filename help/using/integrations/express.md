...
>[!IMPORTANT]
>
>En utilisant l’intégration d’Adobe Express, les données quittent Journey Optimizer. N’utilisez pas cette intégration avec les ISP ou d’autres données de santé.
