...
**Sur cette page :** ajoutez une action LINE à un parcours ou à une campagne et créez du contenu personnalisé, du texte aux autocollants en passant par les images, les vidéos, les emplacements et les messages Flex, afin de pouvoir interagir avec les clients sur LINE.
