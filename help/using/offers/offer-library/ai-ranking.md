...
title: À propos des modèles d’IA
...
## Prise en main des modèles d’IA {#get-started-with-ai-rankings}
...
>[!NOTE]
>
>Actuellement, dans [!DNL Journey Optimizer], le seul type de modèle pris en charge pour le classement par lʼIA est lʼ&#x200B;**optimisation automatique**.
