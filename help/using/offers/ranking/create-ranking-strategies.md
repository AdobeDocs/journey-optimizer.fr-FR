...
1. Indiquez un nom unique et une description pour le modèle d’IA, puis sélectionnez le type de modèle d’IA à créer :
   ...
   * **[!UICONTROL Personnalisé]** optimise et personnalise les offres en fonction des audiences et des performances des offres. [En savoir plus](personalized-optimization-model.md)
...
1. Si vous créez une **[!UICONTROL Optimisation personnalisée]** Modèle AI, sélectionnez la ou les audiences à utiliser pour entraîner le modèle AI.
