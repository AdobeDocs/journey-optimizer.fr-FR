...
* Créez une règle de décision à l’aide d’une audience de chargement personnalisé :
   ...
   1. Utilisez l’onglet **Attributs** et accédez aux schémas d’enrichissement liés à l’audience sélectionnée. Vous pouvez ainsi accéder à toutes les données du fichier CSV et les utiliser dans votre règle. [Découvrir comment créer une règle de décision](../offers/offer-library/creating-decision-rules.md)
  ...
  ![Audience CSV dans la zone de travail des règles de décision](assets/csv-rule.png)
...
* Utilisez des audiences de chargement personnalisé comme contrainte d’offre. [Découvrir comment ajouter des contraintes à une offre](../offers/offer-library/add-constraints.md)
  ...
  ![Options de contrainte d’audience de chargement personnalisées](assets/csv-offer.png)
...
* Utiliser des audiences de chargement personnalisé au niveau de la décision
  ...
  ![Audience de chargement personnalisée au niveau de la décision](assets/csv-decision.png)
