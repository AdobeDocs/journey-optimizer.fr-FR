...
# Mettre à jour une offre de secours

Vous pouvez modifier ou mettre à jour une offre de secours dans votre conteneur en adressant une demande de PATCH à l&#39;API [!DNL Offer Library].
...
Une réponse réussie renvoie les détails mis à jour de l&#39;offre de secours, y compris son identifiant d&#39;instance unique et son offre de secours `@id`.
