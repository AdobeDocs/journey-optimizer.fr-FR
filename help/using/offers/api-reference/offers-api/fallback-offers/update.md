---
title: Mettre à jour une offre de secours
...
# Mettre à jour une offre de secours {#update-fallback-offer}

Vous pouvez modifier ou mettre à jour une offre de secours dans votre conteneur en adressant une requête PATCH à la fonction [!DNL Offer Library] API.
...
Une réponse réussie renvoie les détails mis à jour de l’offre de secours, y compris son identifiant d’instance unique et l’offre de secours. `@id`.
