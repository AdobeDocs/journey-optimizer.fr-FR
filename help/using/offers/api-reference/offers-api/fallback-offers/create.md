...
Vous pouvez créer une offre de secours en envoyant une requête POST à la fonction [!DNL Offer Library] API, lors de la saisie de votre ID de conteneur.
