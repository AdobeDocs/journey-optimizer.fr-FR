...
# Offres personnalisées liste

Une offre personnalisée est un message marketing personnalisable basé sur des règles d&#39;éligibilité et des contraintes.

Vous pouvez vue une liste de toutes les offres personnalisées dans un conteneur en exécutant une seule requête de GET à l&#39;API [!DNL Offer Library].
...
Une réponse réussie renvoie une liste d’offres personnalisées qui sont présentes dans le conteneur auquel vous avez accès.
