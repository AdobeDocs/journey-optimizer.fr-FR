---
title: Offres personnalisées liste
...
# Rechercher une offre personnalisée

Une offre personnalisée est un message marketing personnalisable basé sur des règles d&#39;éligibilité et des contraintes.

Vous pouvez rechercher des offres personnalisées spécifiques en adressant une demande de GET à l&#39;API [!DNL Offer Library] qui inclut soit l&#39;offre personnalisée `@id`, soit le nom de l&#39;offre personnalisée dans le chemin de la demande.
...
| `id` | Chaîne utilisée pour correspondre à la propriété `@id` des entités. La chaîne correspond exactement. Les paramètres &quot;id&quot; et &quot;name&quot; ne peuvent pas être utilisés ensemble. | `xcore:personalized-offer:124cc332095cfa74` |
| `name` | Chaîne utilisée pour correspondre à la propriété xdm:name des entités. La chaîne correspond exactement, avec la mise en majuscules, mais des caractères génériques peuvent être utilisés. Les paramètres `id` et `name` ne peuvent pas être utilisés ensemble. | `Discount offer` |
...
Une réponse réussie renvoie les détails de l&#39;emplacement, y compris des informations sur votre identifiant de conteneur, votre identifiant d&#39;instance et votre offre personnalisée unique `@id`.
