...
Une réponse réussie renvoie des informations sur la collection nouvellement créée, y compris son unique `id`. Vous pouvez utiliser la collection `id` lors d’étapes ultérieures pour mettre à jour ou supprimer votre collection, ou utilisez-la dans un tutoriel ultérieur pour créer une décision.
