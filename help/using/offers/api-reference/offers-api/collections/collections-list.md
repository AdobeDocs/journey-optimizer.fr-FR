...
Vous pouvez vue une liste de toutes les collections au sein d’un conteneur en exécutant une seule requête de GET à l’API [!DNL Offer Library].
