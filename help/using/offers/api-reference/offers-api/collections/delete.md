...
Il peut parfois s’avérer nécessaire de supprimer (DELETE) une collection. Pour ce faire, il vous suffit d’adresser une requête DELETE à l’API [!DNL Offer Library] en utilisant l’`id` de la collection que vous souhaitez supprimer.
