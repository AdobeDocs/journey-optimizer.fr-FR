...
Vous pouvez rechercher une règle de décision spécifique en adressant une requête de GET à la fonction [!DNL Offer Library] API qui inclut la règle de décision `id` dans le chemin d’accès de la requête.
