---
title: Règles de décision liste
...
# Règles de décision liste

Les règles de décision sont des contraintes ajoutées à une offre personnalisée et appliquées à un profil pour déterminer son éligibilité. Vous pouvez vue une liste des règles de décision existantes dans un conteneur en exécutant une seule requête de GET à l&#39;API [!DNL Offer Library].
...
| `limit` | Limiter le nombre de règles de décision renvoyées. | `limit=5` |
...
Une réponse positive renvoie une liste de règles de décision qui sont présentes dans le conteneur auquel vous avez accès.
