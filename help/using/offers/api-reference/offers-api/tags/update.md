...
Vous pouvez modifier ou mettre à jour un qualificateur de collection (précédemment appelé &quot;balise&quot;) en adressant une requête de PATCH à la fonction [!DNL Offer Library] API.
...
| `{ID}` | Conteneur où se trouvent les balises. | `tag1234` |
...
Une réponse réussie renvoie les détails mis à jour du qualificateur de collection et du qualificateur de collection. `id`.
