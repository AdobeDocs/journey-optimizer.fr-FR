...
Vous pouvez modifier ou mettre à jour une décision dans votre conteneur en adressant une requête PATCH à la variable [!DNL Offer Library] API.
...
Une réponse réussie renvoie les détails mis à jour de la décision, y compris son identifiant d’instance unique et l’ID de décision. `@id`.
