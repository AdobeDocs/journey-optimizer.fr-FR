...
>[!NOTE]
>
>Les instructions pour concevoir du contenu accessible pour vos e-mails et pages de destination sont présentées dans [cette section](../email/accessible-content.md).
