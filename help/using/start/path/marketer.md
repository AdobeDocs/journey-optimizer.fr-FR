...
1. **Création de messages**. Découvrez comment créer des e-mails et des notifications push dans Journey Optimizer [sur cette page](../../messages/get-started-content.md). 
