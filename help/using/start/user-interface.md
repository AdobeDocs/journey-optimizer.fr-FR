...
Pour accéder à Adobe Journey Optimizer, connectez-vous à [[!DNL Adobe CX Enterprise]](https://experience.adobe.com?lang=fr) avec votre Adobe ID, puis sélectionnez [!DNL Journey Optimizer].
...
![Page d’accueil Journey Optimizer avec le volet de navigation de gauche, la barre supérieure, l’espace de travail principal et les différentes zones de la page d’accueil](assets/ajo-home.png)
...
Des raccourcis clavier et des fonctionnalités d’accessibilité sont disponibles. [En savoir plus](accessibility.md)
...
| Gestion de contenu | Ressources, modèles, fragments, pages de destination |
