...
title: Quelle fonctionnalité de Journey Optimizer pour cette tâche ?
description: Un guide de décision axé sur les objectifs qui mappe les objectifs courants des professionnels et professionnelles à la fonctionnalité Adobe Journey Optimizer appropriée, avec des tutoriels pratiques, afin que vous puissiez trouver l’outil approprié pour ce que vous souhaitez accomplir et commencer rapidement.
feature: Get Started
...
# Quelle fonctionnalité de Journey Optimizer pour cette tâche ? {#ajo-use-case-guide}
...
>[!TIP]
>
>Vous découvrez Journey Optimizer ? Parcourez l’ensemble des [tutoriels ](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/overview){target="_blank"} (vidéos et procédures pas à pas guidées), suivez une liste de lecture [vidéo organisée par des experts](https://experienceleague.adobe.com/en/playlists?solution=Journey+Optimizer){target="_blank"} et pratiquez-la dans un [sandbox de formation](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/configure-a-training-sandbox/introduction-and-prerequisites){target="_blank"} ou avec les [défis pratiques](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}.
...
| Coordonner la messagerie sur de nombreux canaux à grande échelle | Orchestration | [Évolution de l’orchestration à l’engagement omnicanal](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/scaling-orchestration-to-omnichannel-engagement/introduction){target="_blank"} |
...
Commencez par le canal que vous souhaitez envoyer : [E-mail](../email/get-started-email.md) · [Push](../push/get-started-push.md) · [SMS/MMS/RCS](../mobile/get-started-mobile.md) · [Web](../web/get-started-web.md) · [In-app](../in-app/get-started-in-app.md). Pour obtenir des conseils spécifiques aux appareils mobiles, explorez le [Mobile Learning Hub](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}.

## Mesurer et optimiser {#measure-optimize}

Suivre les performances et affiner : [Rapports dynamiques](../reports/live-report.md) · [Surveillez et analysez votre parcours avec des rapports dynamiques](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports){target="_blank"}. Pour analyser les expériences et obtenir des recommandations sur l’étape suivante, utilisez le [tutoriel ](ai-features.md#experimentation-agent) **(AI)** ([tutoriel](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview){target="_blank"}).
