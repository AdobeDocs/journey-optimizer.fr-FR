...
**Sur cette page :** les événements sont les déclencheurs en temps réel qui lancent vos parcours. Comparez les types de qualification unitaire, métier et audience pour choisir le bon cas d’utilisation.
