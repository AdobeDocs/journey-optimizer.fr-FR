...
description: Découvrez comment configurer votre environnement pour envoyer des messages mobiles et MMS avec Journey Optimizer avec Infobip
...
**Sur cette page :** découvrez comment configurer Infobip en tant que fournisseur dans Adobe Journey Optimizer en configurant les informations d’identification de l’API SMS et comment activer la messagerie RCS via une intégration de fournisseur personnalisé.

>[!ENDSHADEBOX]

En intégrant Infobip à Adobe Journey Optimizer, vous pouvez diffuser des messages mobiles vers vos profils dans le cadre de vos parcours et campagnes.
