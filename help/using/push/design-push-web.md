...
>[!AVAILABILITY]
>
>Actuellement, les notifications push web dans Journey Optimizer ne prennent pas en charge les fonctionnalités **Notification silencieuse** et **Simuler le contenu**, mais seront disponibles ultérieurement.
