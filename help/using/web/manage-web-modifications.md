...
1. Si vous créez une [application à page unique](web-spa.md), vous pouvez appliquer n’importe quelle modification aux autres vues. [En savoir plus](web-spa.md#apply-modifications-views)
