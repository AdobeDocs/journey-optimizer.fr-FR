...
**Sur cette page :** découvrez comment configurer des sous-domaines web dans Adobe Journey Optimizer à l’aide d’un sous-domaine déjà délégué à Adobe ou en configurant un nouveau pour publier du contenu de ressources pour vos expériences web.
