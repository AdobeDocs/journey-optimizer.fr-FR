...
**Sur cette page :** commencez à utiliser le canal web dans Adobe Journey Optimizer pour créer et diffuser visuellement des expériences web personnalisées dans vos parcours et campagnes clientèle.
...
* **[Conditions préalables relatives aux canaux web](web-prerequisites.md)** : comprenez les critères techniques et la configuration nécessaires à l’implémentation des canaux web.
