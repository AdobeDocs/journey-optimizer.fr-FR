...
**Sur cette page :** découvrez comment créer une expérience web par le biais d’un parcours ou d’une campagne, modifier et tester son contenu, rediriger les visiteurs vers une autre URL et la publier, l’activer ou l’arrêter dans Adobe Journey Optimizer.
