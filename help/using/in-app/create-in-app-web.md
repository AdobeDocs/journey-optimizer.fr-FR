...
**Sur cette page :** découvrez comment créer une campagne de messages in-app web dans Adobe Journey Optimizer, de la configuration du canal à la définition de l’audience, des déclencheurs et du contenu.
