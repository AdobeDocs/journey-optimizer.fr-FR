...
**Sur cette page :** découvrez comment concevoir le contenu de votre message web in-app dans Adobe Journey Optimizer, y compris la disposition du message, le média, le texte, les boutons et les options de formatage avancé.
