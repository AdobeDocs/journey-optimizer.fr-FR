...
>[!AVAILABILITY]
>
>La fonction Expérience de contenu n’est actuellement disponible que pour un ensemble d’organisations (disponibilité limitée). Pour plus d’informations, contactez votre représentant Adobe.
...
Adobe Journey Optimizer utilise ensuite des méthodes statistiques avancées &quot;valides à tout moment&quot; pour interpréter ces données de rapport brutes, ce qui vous permet d’interpréter vos rapports d’expérimentation. Voir à ce sujet la section [cette page](../campaigns/experiment-calculations.md).
...
Par exemple, si l’objectif de l’expérience est défini sur **[!UICONTROL Unique Opens]**, et un traitement donné a été présenté à 10 000 profils avec 200 ouvertures uniques enregistrées, ce qui représente une **[!UICONTROL Conversion Rate]** de 2 %. Pour les mesures non uniques, par exemple la mesure Ouvertures , la mesure normalisée s’affiche sous la forme d’une **[!UICONTROL Count per Profile]**, tandis que pour les mesures continues telles que le total du prix, la mesure normalisée s’affiche sous la forme d’une **[!UICONTROL Total per Profile]**.
...
Par exemple, si le traitement A a une **[!UICONTROL Conversion Rate]** de 3 %, alors que le traitement B a une **[!UICONTROL Conversion Rate]** de 2 %, le traitement A est-il meilleur que le traitement B ? Pour y répondre, nous devons d’abord quantifier l’incertitude de ces taux de conversion observés.
...
Adobe déclare qu’une expérience est concluante lorsque le degré de confiance est supérieur à 95 %.
