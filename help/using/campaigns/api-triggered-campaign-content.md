...
**Sur cette page :** concevez et personnalisez le contenu de campagne déclenché par l’API avec des données contextuelles transmises dans la payload de l’API afin que chaque message soit adapté en temps réel pour chaque destinataire.
