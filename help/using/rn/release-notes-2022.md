...
* Avec Journey Optimizer, vous pouvez identifier les actions effectuées par les utilisateurs et utilisatrices du système sur divers services et fonctionnalités tels que les campagnes, les parcours, les messages, les pages de destination, etc. Les ressources de journal d’audit incluent désormais des modifications apportées à diverses autres actions et sont enregistrées automatiquement au fur et à mesure que l’activité se produit. En savoir plus [sur cette page](../privacy/audit-logs.md).
...
<tr>
<td>
<p>Le plug-in d’intégration du Concepteur d’e-mail d’Adobe Journey Optimizer et Adobe Stock offre aux clients et clientes une façon simple de parcourir, d’acquérir les droits d’utilisation et d’enregistrer des images pour les utiliser dans la création de messages. </br> La nouvelle option <b>Rechercher des photos Stock similaires</b> vous permet également de trouver les photos Stock qui correspondent au contenu, à la couleur et à la composition de vos images. </p>
...
<p>Pour plus d’informations, consultez la <a href="../configuration/copy-objects-to-sandbox.md">documentation détaillée</a>.
</td>
</tr>
</tbody>
</table>
...
<p>Pour plus d’informations, consultez la <a href="../building-journeys/conditions.md#profile_cap">documentation détaillée</a>.</p>
</td>
</tr>
</tbody>
</table>
