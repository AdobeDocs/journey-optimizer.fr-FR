...
## Version d’octobre 2023 {#oct-rn-2023}
...
## Version de septembre 2023 {#sept-rn-2023}
...
Additionally, computed attributes simplifies segmentation and journey workflows to help you seamlessly deliver relevant experiences. Pour en savoir plus, consultez la <a href="../audience/computed-attributes.md">documentation détaillée</a>.</p>
...
<p>Pour plus d’informations, consultez la <a href="../reports/channel-report-cja.md">documentation détaillée</a>.</p>
</tr>
</tbody>
</table>
...
## Version de juillet 2023 {#july-rn-2023}
...
Des améliorations ont été apportées au sélecteur d’audiences dans les parcours ou les campagnes, avec l’ajout de nouvelles colonnes indiquant l’origine et la fréquence de mise à jour des audiences. Avec la publication du portail de composition d’audiences, Adobe Experience Platform et Adobe Journey Optimizer ont mis à jour l’utilisation des « audiences » et des « segments » dans le système et la documentation.
...
## Version de juin 2023 {#june-rn-2023}
...
## Version de mai 2023 {#may-rn-2023}
...
* Une nouvelle sous-section fournit des recommandations sur la création de l’adresse **Répondre à (e-mail)** et sur la garantie d’une gestion adéquate des réponses. [En savoir plus](../email/email-settings.md#send-to-suppressed-email-addresses)
...
* Une fois qu’un groupe d’adresses IP a été sélectionné dans une configuration de canal, les informations d’enregistrement PTR sont désormais visibles lorsque vous passez la souris sur les adresses IP. [En savoir plus](../email/email-settings.md#ip-pools)
