...
* Mise à jour de la section Classement par l’IA, dans la documentation dʼOffer Decisioning, afin de fournir une description plus détaillée du modèle d’optimisation automatique. [En savoir plus](../offers/offer-library/create-ranking-strategies.md#auto-optimization)
