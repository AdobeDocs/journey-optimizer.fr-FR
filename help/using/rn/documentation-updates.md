...
* Trois nouvelles alertes de parcours sont désormais disponibles : Parcours publié, Parcours terminé et Limitation d’action personnalisée déclenchée. [En savoir plus](../reports/alerts.md#journey-alerts)
