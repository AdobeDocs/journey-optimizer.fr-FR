...
* Une nouvelle page **Schéma d’exportation de messages** documente chaque champ du jeu de données d’exportation de messages AJO, avec les types de données et la hiérarchie de la payload d’e-mail et de SMS exportée. [En savoir plus](../configuration/message-export-schema.md)
...
* La page **Modifier le contenu d&#39;un email avec l&#39;éditeur HTML avancé** a été déplacée de la section Gestion de contenu vers la section **E-mail** de la documentation. Cette page indique désormais que l’éditeur HTML avancé est disponible dans le Concepteur d’e-mail, pour les e-mails et pour les modèles de contenu d’e-mail. [En savoir plus](../email/email-expert-mode.md)
