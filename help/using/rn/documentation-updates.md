...
* Une nouvelle page est désormais disponible pour la gestion des décisions. Il répertorie tous les opérateurs, assistants et fonctions pris en charge lors de la création d’expressions dans le contenu de l’offre, les règles de décision et les formules de classement. Utilisez cette liste pour éviter les erreurs d’exécution. Seules les fonctions documentées sont prises en charge par la gestion des décisions. [En savoir plus](../offers/personalization-editor-supported-functions.md)
