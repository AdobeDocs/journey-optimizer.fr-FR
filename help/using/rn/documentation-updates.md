...
* La page Optimisation dans les campagnes a été mise à jour pour refléter le fait que l’optimisation est désormais également disponible dans les parcours. [En savoir plus](../campaigns/gs-message-optimization.md)

* Un lien vers le tutoriel vidéo décrivant comment tirer parti de l’optimisation des messages dans une campagne a été ajouté. [En savoir plus](../campaigns/gs-message-optimization.md)
