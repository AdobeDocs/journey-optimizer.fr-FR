...
* Ajout d’une vidéo sur le terrain de jeu de l’éditeur de personnalisation pour vous aider à apprendre à écrire et tester le code de personnalisation à l’aide de données d’exemple. [En savoir plus](../personalization/personalize.md#how-to-videosvideo-perso)
...
* Il est actuellement impossible d’annuler la délégation des sous-domaines depuis l’interface d’utilisation [!UICONTROL Journey Optimizer]. Vous devez contacter votre représentant ou représentante Adobe. Les étapes de délégation d’un sous-domaine sont désormais détaillées pour [e-mails](../configuration/delegate-subdomain.md#undelegate-subdomain), [SMS](../sms/sms-subdomains.md#undelegate-a-subdomain-undelegate-subdomain), [expériences web](../web/web-delegated-subdomains.md#undelegate-a-subdomain-undelegate-subdomain) et [pages de destination](../landing-pages/lp-subdomains.md#undelegate-subdomain).<!--[Read more](../configuration/delegate-subdomain.md#undelegate-subdomain)-->
