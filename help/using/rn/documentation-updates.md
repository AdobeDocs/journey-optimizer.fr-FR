...
* Ajout d’une note à la section Fragments , indiquant que lorsque le suivi est activé dans un parcours ou une campagne, si des liens sont présents dans un fragment et que ce fragment est utilisé dans un e-mail, ces liens sont suivis comme tous les autres liens inclus dans le message. [En savoir plus](../content-management/create-fragments.md#content)
