...
* Mise à jour de la documentation sur les exemples d&#39;implémentation basés sur le code afin d&#39;inclure le champ de jetons dans la propositionAction pour un suivi et une attribution précis dans la prise de décision. [En savoir plus](../code-based/code-based-implementation-samples.md)
