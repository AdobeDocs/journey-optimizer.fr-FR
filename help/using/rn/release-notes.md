...
<p>Date de disponibilité : mercredi 17 février 2026</p>
</td>
</tr>
</tbody>
</table>
...
* **Actions entrantes multiples dans parcours (GA)** - Journey Optimizer prend désormais en charge plusieurs actions entrantes dans parcours (disponibilité générale), ce qui permet une conception de parcours et une gestion des événements plus flexibles.
