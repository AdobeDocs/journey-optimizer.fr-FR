...
**Sur cette page :** Découvrez comment créer des définitions de segment à partir d’attributs et d’événements pour créer des audiences et choisir la méthode d’évaluation en flux continu, par lots ou Edge pour le ciblage dans Adobe Journey Optimizer.
