...
>
>* L’optimisation de l’heure d’envoi est prise en charge dans les régions du hub AEP suivantes : **VA7, NLD2, AUS5, CAN2, GBR9, IND2, CHE2**. Il s’agit de codes de région de déploiement d’Adobe. Contactez votre représentant Adobe si vous ne savez pas quelle région votre organisation utilise.
>
...
1. Pour les messages e-mail et push, définissez **[!UICONTROL Envoyer dans les prochains]** sur le nombre maximal d&#39;heures (2 à 100) que le système attendra avant d&#39;envoyer le message.
...
* **Envoyer dans les prochains** : nombre maximal d’heures (2 à 100) que le système attendra avant d’envoyer le message à un profil donné *(spécifique au produit)*
...
* La plage maximale de temps d’attente est comprise entre 2 et 100 heures ; la plage recommandée est comprise entre 6 et 24 heures pour obtenir de meilleurs résultats.
