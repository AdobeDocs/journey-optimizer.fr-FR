...
description: Guide complet de prise en main de l’orchestration des parcours dans  [!DNL Adobe Journey Optimizer]
...
**Prêt pour la création ?** Découvrez comment créer et concevoir votre premier parcours sur [cette page](journey-gs.md).
...
Envoyez des diffusions en temps réel **diffusion unitaire** déclenchées lorsqu’un événement est reçu ou **par lots** à l’aide d’audiences [!DNL Adobe Experience Platform].
...
Tirez parti des **données contextuelles** issues des événements, des informations des [!DNL Adobe Experience Platform] ou des données provenant de services d’API tiers.
...
[Explorer les activités](../../rp_landing_pages/about-journey-building-landing-page.md)
:::
...
[Guide de dépannage](../../rp_landing_pages/troubleshoot-journey-landing-page.md)
:::
