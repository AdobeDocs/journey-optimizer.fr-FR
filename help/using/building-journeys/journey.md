...
* parcours unitaires **: expériences en temps réel déclenchées par un événement (récupération après abandon de panier, e-mails de bienvenue).**
...
➡️ **[types de Parcours : choisissez le bon](journey-types-selection.md)** - Comparaison détaillée, guide de décision et matrice de compatibilité des fonctionnalités
...
[Utiliser des conditions](conditions.md)
:::
...
[Tout parcourir →](jo-use-cases.md) | [Bibliothèque de cas d’utilisation →](../../rp_landing_pages/journey-use-cases-landing-page.md)
:::
...
[Découvrir les expressions](../../rp_landing_pages/building-advanced-conditions-journeys-landing-page.md)
:::
...
[Copier les parcours](../configuration/copy-objects-to-sandbox.md#objects)
:::
...
[Afficher toutes les fonctionnalités du parcours →](../../rp_landing_pages/manage-journey-landing-page.md)
...
+++ Quel type de parcours dois-je utiliser ?

Utilisez le [guide de décision](journey-types-selection.md#decision-guide) ou le [tableau de comparaison](journey-types-selection.md#journey-types-comparison) pour choisir entre les parcours Unitaire, Lecture d’audience, Qualification d’audience et Événement métier en fonction de votre mécanisme de déclenchement et de votre cas d’utilisation.
...
* **[Dépannage](../../rp_landing_pages/troubleshoot-journey-landing-page.md)** – Diagnostiquer et résoudre les problèmes
...
* **[Hub de gestion des parcours](../../rp_landing_pages/manage-journey-landing-page.md)** – Outils de filtrage, d’optimisation et de gestion des profils
* **[Référence des activités de parcours](../../rp_landing_pages/about-journey-building-landing-page.md)** – Guide complet de tous les types d’activités
