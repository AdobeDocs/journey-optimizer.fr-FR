...
**Sur cette page :** trouvez des réponses aux questions fréquentes sur Journey Orchestration dans Adobe Journey Optimizer, couvrant les concepts généraux, les activités, les événements et le dépannage.
...
* **Activités d’orchestration** : composants logiques tels que les conditions, l’attente, l’audience de lecture, les fragments de parcours et la fin
...
+++ Que sont les fragments de Parcours et quand les utiliser ?

Les **fragments de Parcours** sont des ensembles réutilisables de nœuds de parcours que vous créez une fois et que vous insérez dans n’importe quel parcours de votre sandbox. Ils sont disponibles sous la forme d’une activité d’orchestration dans la zone de travail du parcours.

**Quand utiliser les fragments de Parcours** :

* Vous disposez d’une logique qui se répète sur plusieurs parcours (par exemple, contrôles d’éligibilité, routage de canal préféré, séquences de bienvenue)
* Vous souhaitez appliquer la cohérence entre les équipes : définissez le modèle une fois, réutilisez-le partout
* Vous souhaitez accélérer la création de parcours en évitant de reconstruire des séquences de nœuds courantes à partir de zéro
