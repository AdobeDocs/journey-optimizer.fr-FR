...
**Non.** L’impact se limite à la journalisation uniquement. [!DNL Adobe Journey Optimizer] dispose de mécanismes de déduplication intégrés au niveau de la couche d’exécution des messages qui garantissent :
