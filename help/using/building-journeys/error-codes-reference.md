...
| Code d’erreur | Description | Cause principale | Résolution |
|------------|-------------|-----------|-----------|
| **CJMMAS-1732-500** | L’épreuve a échoué - Toutes les ressources ne sont pas publiées lors de l’envoi de l’épreuve/test avec une ressource AEM | La ressource récemment publiée ne se trouve pas encore dans AJO ; incohérence de l’ID de ressource ; utilisation de référentiels croisés ; décalage de synchronisation AEM | &#x200B;1. Utilisez uniquement les identifiants de ressources publiés à partir du référentiel/de l’environnement approprié<br/>2. Laissez le temps pour la synchronisation entre AEM et AJO<br/>3. Réessayez avec une ressource dont le fonctionnement a été vérifié<br/>4. Vérification du statut de publication des ressources dans AEM <br/><br/>**Documentation connexe** : [Intégration d’Assets](../content-management/assets.md) |
