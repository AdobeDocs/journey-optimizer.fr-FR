...
Le compteur s’applique uniquement à la version du parcours sélectionnée. Le compteur se remet à zéro au bout d’un mois, après une nouvelle version de parcours ou sur une version en double du parcours. Après une réinitialisation, les profils entrants reprennent le chemin nominal jusqu’à ce que la limite de compteur soit atteinte.
