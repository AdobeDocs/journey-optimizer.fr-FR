...
**Sur cette page :** Découvrez comment les actions et les actions personnalisées vous permettent de fournir des expériences personnalisées et de connecter des systèmes tiers par le biais d’appels d’API REST, afin d’étendre les parcours au-delà de la messagerie intégrée.
