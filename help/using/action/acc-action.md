...
1. Cliquez sur **[!UICONTROL Tester]** pour valider la connexion au nouveau point d’entrée. Vérifiez que le test renvoie une réponse de réussite avant de continuer.
1. Une fois la validation effectuée, cliquez sur **[!UICONTROL Enregistrer]** pour appliquer vos modifications.

>[!NOTE]
>
>Tous les parcours qui utilisent cette action utiliseront automatiquement la configuration mise à jour. Si des parcours actifs utilisent cette action, surveillez-les étroitement après la mise à jour du point d’entrée pour assurer une diffusion correcte des messages.
