...
* Un parcours ne peut pas utiliser à la fois les [ actions de canal intégrées ](../building-journeys/journeys-message.md) et les [actions de Campaign Standard](../building-journeys/using-adobe-campaign-standard.md).
