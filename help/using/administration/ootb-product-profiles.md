...
| Gestion des décisions | <ul> <li>**[!DNL Manage decisions]** : la lecture, la création, la modification et la suppression des décisions.</li> <li>**[!DNL Manage ranking strategies]** : la lecture, la création, la modification et la suppression des stratégies de classement.</li> </ul> |
| Parcours | <ul> <li>**[!DNL Manage journeys]** : lecture, création, modification, mise en pause, arrêt et suppression des parcours.</li> <li>**[!DNL Manage journeys events, data sources and actions]** : lecture, création, modification et suppression des événements, des sources ou des actions.</li> <li>**[!DNL Publish journeys]** : publication des parcours.</li> <li>**[!DNL View journeys report]** : lecture et modification du rapport de parcours.</li> </ul> |
