...
description: En savoir plus sur le contrôle d’accès au niveau de l’objet qui permet de définir des autorisations pour gérer l'accès aux données sur une sélection d'objets
