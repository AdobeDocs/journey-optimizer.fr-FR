...
Configurez les informations d’identification en fonction de votre fournisseur SMS à l’aide de [Prise en main de la configuration des SMS/MMS/RCS](sms-configuration.md). Suivez ensuite les étapes ci-dessous pour sélectionner le jeu de données entrant personnalisé.
