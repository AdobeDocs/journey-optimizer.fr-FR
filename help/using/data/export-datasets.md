...
**Sur cette page :** Configurez des connexions actives à des destinations d’espace de stockage afin de pouvoir exporter vos jeux de données Journey Optimizer à des fins de création de rapports, d’archivage et d’analyse de données externes.
