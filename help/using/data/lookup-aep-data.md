...
**Sur cette page :** Activez les jeux de données Adobe Experience Platform basés sur des enregistrements pour la recherche afin d’enrichir la personnalisation, la prise de décision et l’orchestration des parcours avec des données de référence et transactionnelles récupérées au moment de l’exécution dans Journey Optimizer.
