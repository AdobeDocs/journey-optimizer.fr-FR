...
<tr style="border: 0;">
  <td>
    ...
    <p>Nouvelles fonctionnalités, dernières améliorations et correctifs</p>
   <p>
    <div>
      <a href="using/start/quick-start.md">Guide de démarrage rapide</a>
    </div>
    <p>Découvrez comment commencer en tant qu’administrateur, ingénieur de données ou praticien de Parcours</p>
    <p>
    <p>
    <div>
    ...
    <p>Découvrez les étapes clés de la configuration de . [!DNL Journey Optimizer]</p>
    <p>
    <div>
    ...
    <p>
    <div>
    <p>Inscrivez-vous au <a href="https://www.adobe.com/subscription/Adobe_Journey_Optimizer_NL.html" target="_blank">newsletter trimestrielle Adobe Journey Optimizer</a>.</p>
    <p>Recevez les dernières mises à jour produits, les articles les plus intéressants, des cas pratiques, des conseils et bien plus encore, directement dans votre boîte de réception, tous les trimestres. Dans chaque newsletter, vous trouverez :</p>
    ...
    <li>Conseils et astuces pour aider à offrir aux clients des expériences qui favorisent le succès commercial</li>
  </td>
   <td>
   <div><strong>Liens directs vers les ressources clés</strong>
    ...
    <li>
      <a href="using/privacy/requests.md">Demandes</a>
        ...
        <li>
      <a href="using/privacy/audit-logs.md"target="_blank">Journal</a>
    </li>
        <li>
