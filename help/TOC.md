...
+ Nouveautés {#whats-new}
   ...
   + {hide-from-toc}[Notes de version préliminaire](using/rn/e-release-notes.md)
...
+ Commencer {#get-started}
   ...
   + Principes de base {#essentials}
      ...
      + [Commencer à partir de votre objectif](using/start/ajo-use-case-guide.md)
...
+ Parcours {#orchestrate-journeys}
   ...
   + {hide-from-toc}[types de Parcours : choisissez le bon](using/building-journeys/journey-types-selection.md)
   ...
   + Gérer vos parcours {#manage-journey}
      ...
      + [Organiser avec des balises](using/building-journeys/tags.md)
   ...
   + Activités {#about-journey-building}
      ...
      + Optimiser {#optimize-activity}
         + [Prise en main de l’activité Optimisation](using/building-journeys/optimize.md)
         + [Expérimentation des chemins](using/building-journeys/path-experimentation.md)
   ...
   + Créer des expressions {#building-advanced-conditions-journeys}
      ...
      + [Générer des expressions à l’aide de l’assistant d’expressions](using/building-journeys/expression/expression-agent.md)
      + Syntaxe {#syntax}
         ...
         + {hide-from-toc}[Exemples](using/building-journeys/expression/advanced-editor-use-cases.md)
   ...
   + Cas d’utilisation {#journey-use-cases}
      ...
      + {hide-from-toc}[Accélérer les diffusions](using/building-journeys/ramp-up-deliveries-uc.md)
...
+ Défis de fidélité {#loyalty-challenges}
   + {hide-from-toc}[Commencer avec les défis de fidélité](using/loyalty-challenges/get-started.md)
   + {hide-from-toc}[Accéder aux défis et aux tâches et les gérer](using/loyalty-challenges/access-loyalty-challenges.md)
   + {hide-from-toc}[Créer des défis](using/loyalty-challenges/create-challenges.md)
   + {hide-from-toc}[Créer des tâches](using/loyalty-challenges/create-tasks.md)
   + {hide-from-toc}[Surveiller les performances des défis de fidélité](using/loyalty-challenges/loyalty-reporting.md)
   + {hide-from-toc}[Configurer les défis de fidélité](using/loyalty-challenges/loyalty-admin.md)
   + {hide-from-toc}[Données et jeux de données de fidélité](using/loyalty-challenges/loyalty-data-and-datasets.md)
   + {hide-from-toc}[Référence de l’API Loyalty Challenges](https://developer.adobe.com/journey-optimizer-apis/references/loyalty-challenges)
+ Campagnes {#campaigns}
   + {hide-from-toc}[Campagnes](/help/rp_landing_pages/campaigns-landing-page.md)
   ...
   + Campagnes déclenchées par API {#api-triggered-campaigns}
      ...
      + [Utiliser les campagnes déclenchées par API](using/campaigns/api-triggered-campaigns.md)
   ...
   + Campagnes orchestrées {#orchestrated-campaigns}
      ...
      + Lancer votre première campagne orchestrée {#launch}
         ...
         + [Ajouter une personnalisation](using/orchestrated/add-personalization.md)
      ...
      + Interrogation de la base de données {#query-database}
         ...
         + [Utiliser des filtres prédéfinis](using/orchestrated/predefined-filters.md)
      ...
      + Opérations avancées {#orchestrated-advanced}
         + [Utiliser des variables dans des campagnes orchestrées](using/orchestrated/variables-orchestrated-campaigns.md)
...
+ Conflit et hiérarchisation {#conflict-prioritization}
   ...
   + Arbitrage des parcours {#journey-arbitration}
      + [Utiliser des formules pour classer les parcours](using/conflict-prioritization/journey-ranking-formulas.md)
      + [Utiliser les modèles d’IA pour classer les parcours](using/conflict-prioritization/journey-ai-models.md)
...
+ Canaux de communication {#channels}
   ...
   + Canal e-mail {#email}
      ...
      + Concevoir le contenu de vos e-mails {#design-email}
         + {hide-from-toc}[Concevoir le contenu de vos e-mails](/help/rp_landing_pages/design-email-landing-page.md)
         ...
         + Créer votre contenu {#add-content}
            + {hide-from-toc}[Concevoir votre contenu](/help/rp_landing_pages/add-content-landing-page.md)
            ...
            + [Personnaliser les URL](using/email/url-personalization.md)
            + [Insérer des offres personnalisées](using/email/add-offers-email.md)
            + [Optimiser les e-mails pour les boîtes de réception d’IA](using/email/llm-email-optimizer.md)
            + [Gérer la version texte](using/email/text-version-email.md)
         ...
         + [Vérification du contenu](using/email/content-check.md)
      ...
      + [Utiliser et configurer des liens profonds](using/email/deeplinks.md)
   ...
   + Canal SMS/MMS/RCS {#mobile}
      + [Commencer avec les messages mobiles](using/mobile/get-started-mobile.md)
      + [Créer un message mobile](using/mobile/create-mobile-message.md)
      + [Créer un message mobile](using/mobile/design-mobile.md)
      ...
      + Configurer le canal mobile {#configure-mobile}
         ...
         + [Créer une configuration mobile](using/mobile/mobile-configuration-surface.md)
   ...
   + Boîte de réception {#inbox}
      + [Prise en main de la boîte de réception](using/inbox/inbox-gs.md)
      + [Configurer le canal Boîte de réception dans Journey Optimizer](using/inbox/inbox-configuration.md)
      + [Créer votre boîte de réception](using/inbox/inbox-create.md)
      + [Concevoir votre boîte de réception](using/inbox/inbox-design.md)
   + WhatsApp {#whatsapp}
   ...
   + Activités en direct {#live-activity}
      ...
      + [Résoudre les problèmes liés aux activités en direct](using/mobile-live/troubleshoot-mobile-live.md)
...
+ Gestion de contenu {#content-management}
   ...
   + Personnalisation {#personalization}
      ...
      + [Chiffrer les paramètres d’URL dans les liens de tracking](using/personalization/url-parameter-encryption.md)
      + Liste des fonctions d’assistance {#functions}
         ...
         + {hide-from-toc}[Assistant de recherche de données externes](using/personalization/external-data-lookup.md)
      ...
      + Cas d’utilisation de personnalisation {#personalization-use-cases}
         ...
         + [Recettes de personnalisation](using/personalization/personalization-recipes.md)
   ...
   + Modèles de contenu {#content-templates}
      ...
      + [Convertir des images en modèles d’e-mail](using/content-management/image-to-html.md)
   ...
   + Cas d’utilisation inter-solutions {#combine}
      ...
      + Intégrations {#integrations}
         ...
         + Exemples de fournisseurs {#vendors}
            + [Commencer avec l’intégration des fournisseurs](using/integrations/vendor-integration-gs.md)
            + [Exemples de configurations de fournisseur](using/integrations/vendor-integration.md)
      + [Utiliser les outils d’IA via MCP](/help/using/integrations/ajo-mcp.md)
   + Assistant IA pour la génération de contenu {#ai-assistant}
      ...
      + [Assistant IA pour les expressions de personnalisation](using/content-management/generative-personalization-expressions.md)
...
+ Création de rapports {#reporting}
   ...
   + Rapport complet {#channel-report}
      ...
      + Rapports de campagne {#campaign-reporting}
         ...
         + {hide-from-toc}[Rapport de campagne d’activité en direct](using/reports/campaign-global-report-cja-activity.md)
...
+ Fonctionnalités de décision {#decisioning}
   ...
   + Prise de décision {#experience-decisioning}
      ...
      + Migrer vers la prise de décision {#migrate-to-decisioning}
         + [Avantages de la migration vers la prise de décision](using/experience-decisioning/migrate-to-decisioning.md)
         + [API de migration vers la prise de décision](using/experience-decisioning/decisioning-migration-api.md)
      + Référence d’API {#experience-decisioning-api-reference}
         + {hide-from-toc}[Référence d’API](/help/rp_landing_pages/experience-decisioning-api-reference-landing-page.md)
      ...
      + Créer des classements {#experience-decisioning-rankings}
         ...
         + Modèles d’IA {#experience-decisioning-ai-models}
            ...
            + [Surveiller les performances de vos modèles d’IA](using/experience-decisioning/ranking/ai-model-observability.md)
      ...
      + Collecter les données d’événement {#experience-decisioning-collect-event-data}
         + {hide-from-toc}[Commencer avec la collecte de données](using/experience-decisioning/data-collection/data-collection.md)
         + {hide-from-toc}[Créer un jeu de données pour collecter des événements](using/experience-decisioning/data-collection/create-dataset.md)
...
+ Configuration des canaux {#configuration}
   ...
   + {hide-from-toc}[Schéma d’export des messages AJO](using/configuration/message-export-schema.md)
   ...
   + Déléguer les sous-domaines d’e-mail {#delegate-subdomains}
      ...
      + [Migration de CNAME vers la délégation personnalisée](using/configuration/custom-subdomain-migration.md)
   ...
   + Mettre en œuvre un plan de préchauffage d’adresses IP {#implement-ip-warmup-plan}
      ...
      + {hide-from-toc}[Fichiers du plan de préchauffage des adresses IP](using/configuration/ip-warmup-plan-files.md)
   + Surveiller les adresses e-mail {#monitor-reputation}
      + [Surveiller les adresses e-mail](/help/rp_landing_pages/monitor-reputation-landing-page.md)
      + {hide-from-toc}[Types d’erreur avec les e-mails](using/configuration/email-error-types.md)
