...
+ Tester et approuver {#test}
   ...
   + Gestion des conflits et hiérarchisation {#conflict-prioritization}
      ...
      + [Identifier les conflits potentiels](using/test-approve/conflicts.md)
      + [Attribution de scores de priorité](using/test-approve/priority-scores.md)
      + [Limitation et arbitrage des parcours](using/test-approve/journey-capping.md)
...
+ Suivre et surveiller {#reporting}
   ...
   + Expérience de création de rapports mise à jour {#channel-report}
      ...
      + Rapports de campagne{#reporting}
         ...
         + [Rapport de campagne d’expérience](using/reports/campaign-global-report-cja-experimentation.md)
...
+ Gestion des données {#data-management}
   ...
   + [Mises à jour de la segmentation par flux et par la durée de vie](using/data/datasets-ttl.md)
