...
+ Gestion de contenu {#content-management}
   ...
   + Personnalisation {#personalization}
      ...
      + Utiliser des données Adobe Experience Platform à des fins de personnalisation {#aep-data-perso}
   ...
   + Modèles de contenu {#content-templates}
      ...
      + [Modifier les modèles d’e-mail en mode expert](using/content-management/email-template-expert-mode.md)
