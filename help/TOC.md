...
+ Nouveautés {#whats-new}
   ...
   + {hide-from-toc}[Notes de mise à jour](using/rn/release-notes-2.md)
   + {hide-from-toc}[Notes de mise à jour](using/rn/release-notes-3.md)
...
+ Défis de fidélité {#loyalty-challenges}
   ...
   + {hide-from-toc}[Configurer le programme de fidélité](using/loyalty-challenges/loyalty-admin.md)
