...
user-guide-description: Utilisez Journey Optimizer pour créer et diffuser des expériences connectées, contextuelles et personnalisées à vos clients.
type: Documentation
...
+ [Documentation de Journey Optimizer](ajo-home.md)
...
+ Parcours {#orchestrate-journeys}
   ...
   + Création d’un parcours{#create-journey}
      ...
      + [Concevoir votre parcours](using/building-journeys/using-the-journey-designer.md)
   ...
   + Gérer les parcours{#mannage-journey}
      + [Terminer le parcours](using/building-journeys/end-journey.md)
      ...
      + [Copie d’un parcours vers un autre environnement de test](using/building-journeys/copy-to-sandbox.md)
      + [Résolution des problèmes liés à votre parcours](using/building-journeys/troubleshooting.md)
   ...
   + Activités {#about-journey-building}
      ...
      + [Actions Adobe Campaign v7/v8](using/building-journeys/using-adobe-campaign-classic.md)
   ...
   + Création d’expressions {#building-advanced-conditions-journeys}
      ...
      + Fonctions {#main-functions-journey}
         ...
         + Liste {#list}
            ...
            + [intersection](using/building-journeys/functions/functionintersect.md)
   ...
   + Cas d’utilisation {#journey-use-cases}
      + Cas d’utilisation métier {#business-use-cases}
         + [Envoi de messages multicanaux](using/building-journeys/journeys-uc.md)
         + [Envoyer un message à l&#39;aide de Campaign v7/v8](using/building-journeys/ajo-ac.md)
...
+ Campagnes{#campaigns}
   ...
   + [Révision et activation d’une campagne](using/campaigns/review-activate-campaign.md)
...
+ Canal email {#email}
   + [Prise en main des emails](using/email/get-started-email.md)
   + [Créer un email](using/email/create-email.md)
   + Concevoir le contenu de vos emails {#design-email}
      + [Prise en main de la conception d&#39;emails](using/email/get-started-email-design.md)
      + Commencer à créer du contenu {#start-creating-content}
         + [Commencer à partir de zéro](using/email/content-from-scratch.md)
         + [Importer le contenu de votre email](using/email/existing-content.md)
         + [Code votre propre contenu](using/email/code-content.md)
         + [Utilisation de modèles](using/email/email-templates.md)
      + Concevoir votre contenu {#add-content}
         + [Utilisation des composants de contenu](using/email/content-components.md)
         + [Ajout de liens et suivi des messages](using/email/message-tracking.md)
         + Gestion des ressources {#manage-asset}
            + [Utilisation de Assets Essentials](using/email/assets-essentials.md)
      ...
      + Modifier le style {#edit-style}
         + [Prise en main du style email](using/email/get-started-email-style.md)
...
+ Canal SMS{#sms}
   ...
   + [Configuration du canal SMS](using/sms/sms-configuration.md)
+ Canal Courrier {#direct-mail}
   + [Créer un courrier](using/direct-mail/create-direct-mail.md)
   + [Configuration du courrier](using/direct-mail/direct-mail-configuration.md)
+ Canal web{#web}
...
+ Landing pages {#landing-pages}
   ...
   + [Créer une landing page](using/landing-pages/create-lp.md)
   + Concevoir du contenu {#landing-pages-design}
      ...
      + [Créer des modèles](using/landing-pages/lp-templates.md)
   ...
   + [Découvrez les cas pratiques](using/landing-pages/lp-use-cases.md)
   + Configuration des landing pages {#lp-configuration}
      + [Configuration des sous-domaines de landing page](using/landing-pages/lp-subdomains.md)
      + [Définition des paramètres prédéfinis de page d’entrée](using/landing-pages/lp-presets.md)
+ Personnalisation et contenu dynamique {#personalized-dynamic-content}
   + Personnalisation {#personalization}
      ...
      + [Contexte de personnalisation](using/personalization/personalization-contexts.md)
...
+ Tracker et suivre vos diffusions {#reporting}
   + Rapport en direct {#live-report}
      + [Prise en main du rapport en direct](using/reports/live-report.md)
      + [Rapport Journey Live](using/reports/journey-live-report.md)
   ...
   + Rapports de parcours {#reports}
      ...
      + Champs d’événement d’étape hérités {#legacy-step-event-fields}
         + [A propos des champs hérités](using/reports/sharing-legacy-fields.md)
         + [Champs du parcours](using/reports/sharing-journey-fields.md)
         + [Champs communs](using/reports/sharing-common-fields.md)
         + [Champs d&#39;exécution des actions](using/reports/sharing-execution-fields.md)
         + [Champs de récupération des données](using/reports/sharing-fetch-fields.md)
...
+ Gestion des décisions {#offer-decisioning}
   ...
   + Création de composants {#create-components}
      ...
      + [Créer des balises](using/offers/offer-library/creating-tags.md)
   + Création de classements {#rankings}
      ...
      + Modèles AI {#ai-models}
         + [À propos des modèles AI](using/offers/ranking/ai-models.md)
         + Types de modèle AI {#ai-model-types}
            + [Modèle d’optimisation automatique](using/offers/ranking/auto-optimization-model.md)
            + [Modèle d’optimisation personnalisé](using/offers/ranking/personalized-optimization-model.md)
         + Création de modèles AI {#configure-ai-model}
            + [Création d’un jeu de données pour la collecte d’événements](using/offers/ranking/create-dataset.md)
   ...
   + Créer et gérer des décisions {#create-manage-activities}
      ...
      + [Créer des simulations](using/offers/offer-activities/simulation.md)
   ...
   + Exporter votre catalogue d&#39;offres {#export-catalog}
      + [Prise en main de l&#39;export du catalogue d&#39;offres ](using/offers/export-catalog/get-started-export.md)
      ...
      + [Jeu de données de placements](using/offers/export-catalog/export-placements.md)
   ...
   + Référence d’API {#api-reference}
      ...
      + Créer et gérer des offres à l’aide d’API {#offers-api}
         + Emplacements {#placements}
            + [Lister des emplacements](using/offers/api-reference/offers-api/placements/placements-list.md)
            + [Rechercher un emplacement](using/offers/api-reference/offers-api/placements/lookup.md)
            + [Créer un emplacement](using/offers/api-reference/offers-api/placements/create.md)
            + [Mettre à jour un emplacement](using/offers/api-reference/offers-api/placements/update.md)
            + [Supprimer un emplacement](using/offers/api-reference/offers-api/placements/delete.md)
         + Règles de décision {#decision-rules}
            + [Lister des règles de décision](using/offers/api-reference/offers-api/decision-rules/rules-list.md)
         ...
         + Balises {#tags}
            + [Lister des balises](using/offers/api-reference/offers-api/tags/tags-list.md)
            + [Rechercher une balise](using/offers/api-reference/offers-api/tags/lookup.md)
         ...
         + Offres personnalisées {#personalized-offers}
            + [Lister des offres personnalisées](using/offers/api-reference/offers-api/personalized-offers/offers-list.md)
         ...
         + Collections {#collections}
            + [Lister des collections](using/offers/api-reference/offers-api/collections/collections-list.md)
            + [Rechercher une collection](using/offers/api-reference/offers-api/collections/lookup.md)
         ...
         + Offres de secours {#fallback-offers}
            + [Lister des offres de secours](using/offers/api-reference/offers-api/fallback-offers/fallback-list.md)
            ...
            + [Mettre à jour une offre de secours](using/offers/api-reference/offers-api/fallback-offers/update.md)
            + [Supprimer une offre de secours](using/offers/api-reference/offers-api/fallback-offers/delete.md)
      + Créer et gérer des décisions à l’aide d’API {#activities-api}
         + [Lister des décisions](using/offers/api-reference/activities-api/activities/activities-list.md)
         + [Rechercher une décision](using/offers/api-reference/activities-api/activities/lookup.md)
...
+ Configuration{#configuration}
   ...
   + Délégation de sous-domaines de messagerie {#delegate-subdomains}
   ...
   + [Configuration des surfaces de canal](using/configuration/channel-surfaces.md)
   + Surveiller les adresses email {#monitor-reputation}
   ...
   + Configuration des parcours {#configure-journeys}
      ...
      + Configuration des événements {#events-journeys}
         ...
         + [Configuration d’un événement commercial](using/event/about-creating-business.md)
...
+ Confidentialité {#privacy}
   ...
   + Gérer le consentement {#consent}
      + [Gérer le droit d’opposition](using/privacy/opt-out.md)
