...
[Explorer les fonctions d’agrégation](../using/building-journeys/functions/aggregation-functions.md)
:::
...
[Explorer les fonctions de conversion](../using/building-journeys/functions/conversion-functions.md)
:::
...
[Afficher la documentation des fonctions de date](../using/building-journeys/functions/date-functions.md)
:::
