...
description: Découvrez comment envoyer des messages par le biais de Adobe Campaign Standard, Campaign v7/v8 et Marketo Engage à partir de parcours Journey Optimizer à l’aide d’actions personnalisées.
...
[Intégration à Campaign Standard](../using/action/acs-action.md)
:::
...
[Intégration à Campaign v7/v8](../using/action/acc-action.md)
:::
