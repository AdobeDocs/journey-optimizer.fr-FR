...
description: Découvrez comment envoyer des messages par le biais d’Adobe Campaign Standard, de Campaign v7/v8 et de Marketo Engage à partir de parcours Journey Optimizer à l’aide d’actions personnalisées.
...
[Intégrer à Campaign Standard](../using/action/acs-action.md)
:::
...
[Intégrer à Campaign v7/v8](../using/action/acc-action.md)
:::
