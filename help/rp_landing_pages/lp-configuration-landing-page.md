...
description: Découvrez comment configurer les sous-domaines et les préréglages de page de destination dans Journey Optimizer pour héberger, personnaliser et gérer vos pages de destination de manière cohérente.
...
Cette section couvre deux aspects :
...
Que vous utilisiez des domaines existants ou de nouvelles configurations, ces étapes vous permettent d’adapter vos pages de destination à vos campagnes et objectifs.
...
Configurer et gérer les sous-domaines des pages de destination

Découvrez comment configurer et gérer les sous-domaines pour l’hébergement de pages de destination dans Adobe Journey Optimizer.
