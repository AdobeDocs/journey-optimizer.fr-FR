...
hide: true
hidefromtoc: true
source-git-commit: a80c343541728f9203f4a59dd10092dc4d427e46
workflow-type: tm+mt
...
## Pages mises à jour - Nouvelles sections ou conseils
...
- [Propriétés de campagne déclenchées par l’API](help/using/campaigns/api-triggered-campaign-properties.md) - 23 octobre
- [Campagnes déclenchées par l’API](help/using/campaigns/api-triggered-campaigns.md) - 29 octobre
- [Actions de campagne](help/using/campaigns/campaign-action.md) - 29 octobre
- [Optimisation des messages de campagne](help/using/campaigns/campaigns-message-optimization.md) - 22 octobre
- [Créer des campagnes](help/using/campaigns/create-campaign.md) - 29 octobre
- [Prise en main des campagnes](help/using/campaigns/get-started-with-campaigns.md) - 29 octobre
- [Gérer les campagnes](help/using/campaigns/manage-campaigns.md) - 23 octobre
...
- [Contenu accessible](help/using/email/accessible-content.md) - 25 octobre
- [Composants de contenu d’e-mail](help/using/email/content-components.md) - 25 octobre
- [Contenu à partir de zéro](help/using/email/content-from-scratch.md) - 25 octobre
- [Paramètres de messagerie](help/using/email/email-settings.md) - 22 octobre
- [Importer du contenu existant](help/using/email/existing-content.md) - 30 octobre
- [Configuration des e-mails](help/using/email/get-started-email-config.md) - 22 octobre
- [Conception d’e-mail](help/using/email/get-started-email-design.md) - 30 octobre
- [Style des e-mails](help/using/email/get-started-email-style.md) - 25 octobre
- [Tracking des URL](help/using/email/url-tracking.md) - 25 octobre
- [Mécanismes de sécurisation d’Experience Decisioning](help/using/experience-decisioning/decisioning-guardrails.md) - 25 octobre
- [Formules de classement](help/using/experience-decisioning/ranking/ranking-formulas.md) - 28 octobre
- [Règles d’éligibilité](help/using/experience-decisioning/rules.md) - 23 octobre
- [Créer des messages in-app](help/using/in-app/create-in-app.md) - 27 octobre
- [Configuration in-app](help/using/in-app/inapp-configuration.md) - 23 octobre
- [Intégration d’Adobe Assets](help/using/integrations/assets.md) - 28 octobre
- [Concevoir des pages de destination](help/using/landing-pages/design-lp.md) - 25 octobre
- [Contenu de la page de destination](help/using/landing-pages/lp-content.md) - 25 octobre
- [Formulaires de page de destination](help/using/landing-pages/lp-forms.md) - 24 octobre
- [Préréglages de page de destination](help/using/landing-pages/lp-presets.md) - 25 octobre
- [Mécanismes de sécurisation de la gestion des décisions](help/using/offers/decision-management-guardrails.md) - 25 octobre
- [Prise en main des campagnes orchestrées](help/using/orchestrated/gs-orchestrated-campaigns.md) - 29 octobre
- [Schéma manuel](help/using/orchestrated/manual-schema.md) - 23 octobre
- [Dimension cible](help/using/orchestrated/target-dimension.md) - 24 octobre
- [Recherche de données externes](help/using/personalization/external-data-lookup.md) - 28 octobre
...
- [Partage des champs d’exécution](help/using/reports/sharing-execution-fields.md) - 29 octobre
- [Configuration personnalisée des SMS](help/using/sms/sms-configuration-custom.md) - 24 octobre
- [Configuration des SMS Infobip](help/using/sms/sms-configuration-infobip.md) - 27 octobre
- [Configuration du SMS Sinch](help/using/sms/sms-configuration-sinch.md) - 27 octobre
- [Mécanismes de sécurisation et limitations](help/using/start/guardrails.md) - 22 octobre
- [Dépannage](help/using/start/troubleshooting.md) - 27 octobre
- [Configuration de WhatsApp](help/using/whatsapp/whatsapp-configuration.md) - 22 octobre

*Rapport généré le 3 novembre 2025*

*Exclut : modifications de formatage, mises à jour des métadonnées, correctifs de linter, mises à jour de la navigation dans la table des matières et nettoyage de la migration*
